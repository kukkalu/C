...
bot = Client("bot",    
   bot_token="7316805103:AAHX1owWhHZmRkVmkDKd7adRApCC0aiKXIo",    
   api_id= 23031620,    
...
async def restart_handler(_, m):    
    await m.reply_text("🚯 **BROKEN HEART 💔** 🚯", True)    
...
async def account_login(bot: Client, m: Message):    
    ...
    try:    
        for i in range(count - 1, len(links)):
            ...
            elif 'media-cdn-a.classplusapp.com' in url:
                tokencp ='eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..0oi58SRgPcKtA-vSoYFBiBh2_dIsGnFnlTak1oaxXZZtAzpEo1omoE5zoc4cim9U'
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': tokencp}).json()['url']
            
            elif 'cpvod' in url:
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={
                    tokencp ='eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..hM33P2ai6ivdzxPPfm01LAd4JWv-vnrSxGXqvCirCSpUfhhofpeqyeHPxtstXwe0'
                }).json()['url']
                
            elif 'awebvideos.classplusapp' in url:
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={
                    tokencp ='your-token-here'
                }).json()['url']
